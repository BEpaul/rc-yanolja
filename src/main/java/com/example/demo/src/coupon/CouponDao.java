...
public class CouponDao {
    ...
    public List<GetCouponRes> getCoupons() {
        String getCouponsQuery = "select * from coupon where status = 1";
    ...
    public List<GetCouponRes> getCouponsByUserId(Long userId) {
        String getCouponsByUserIdQuery = "select * from coupon where user_id = ? and status = 1";
    ...
    public GetCouponRes getCouponByCouponId(Long couponId) {
        String getCouponByCouponIdQuery = "select * from coupon where coupon_id = ? and status = 1";
    ...
    public int modifyCouponStatus(PatchCouponReq patchCouponReq) {
        String modifyCouponStatusQuery = "update coupon set status = ? where coupon_id = ?";
        Object[] modifyCouponStatusParams = new Object[]{patchCouponReq.getStatus(), patchCouponReq.getCouponId()};
